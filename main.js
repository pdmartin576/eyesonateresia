$('#menu-toggle').click(function(){
  ...
  const search = [
    ...
    { name: 'magnava', anchorLink: 'pages/character/index.html#magnava', secret: false},
    { name: 'porsculla', anchorLink: 'pages/character/index.html#porsculla', secret: false},
    { name: 'tovarich', anchorLink: 'pages/character/index.html#tovarich', secret: false},
    { name: 'kasparak', anchorLink: 'pages/character/index.html#kasparak', secret: false},
    { name: 'loravia', anchorLink: 'pages/character/index.html#loravia', secret: false},
    { name: 'hevesta', anchorLink: 'pages/character/index.html#hevesta', secret: false},
    { name: 'vospol', anchorLink: 'pages/character/index.html#vospol', secret: false},
